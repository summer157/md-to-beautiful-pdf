// Theme: latex — imported from Typora CSS
// Generated by md-to-beautiful-pdf

#let doc-title = "%%DOC_TITLE%%"
#let doc-author = "%%DOC_AUTHOR%%"
#let accent       = rgb("#000000")
#let text-clr     = rgb("#000000")
#let light-text   = rgb("#4d4d4d")
#let link-clr     = rgb("#183a63")
#let code-clr     = rgb("#000000")
#let code-bg      = rgb("#f7f4ee")
#let block-bg     = rgb("#fbfaf7")
#let quote-border = rgb("#000000")
#let border-clr   = rgb("#00000029")
#let table-hdr    = rgb("#f5f5f5")
#let table-even   = rgb("#f5f5f5")
...
#set text(
  font: ("Backtick Serif Fix", "New Computer Modern", "Latin Modern Roman", "Noto Nastaliq Urdu", "Times New Roman", "PingFang SC", "Noto Sans CJK SC", "Hiragino Sans GB"),
  size: 11pt,
  fill: text-clr,
  lang: "zh",
)
...
#show heading.where(level: 1): it => {
  block(above: 2em, below: 0.8em, sticky: true)[
    #set text(size: 22pt, weight: "bold", fill: rgb("#000000"))
    #it.body
  ]
}
...
#show heading.where(level: 2): it => {
  block(above: 1.6em, below: 0.55em, sticky: true)[
    #set text(size: 16pt, weight: "bold", fill: rgb("#000000"))
    #it.body
  ]
}
...
#show raw.where(block: true): it => {
  block(
    ...
    #set text(
      font: ("JetBrains Mono", "Cascadia Code", "Menlo", "Courier New", "Latin Modern Mono"),
      size: 9pt,
      fill: rgb("#000000"),
    )
    #it

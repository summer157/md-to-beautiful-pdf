// Theme: purple-plain — imported from Typora CSS
...
#let code-clr     = rgb("#7B4BEB")
#let code-bg      = rgb("#f4f2f9")
#let block-bg     = rgb("#f6f6f6")
#let quote-border = rgb("#7B4BEB")
...
#show heading.where(level: 1): it => {
  block(above: 2em, below: 0.8em, sticky: true)[
    #set text(size: 22pt, weight: "bold", fill: rgb("#7B4BEB"))
    #it.body
  ]
}
...
#show heading.where(level: 2): it => {
  block(above: 1.6em, below: 0.55em, sticky: true)[
    #set text(size: 16pt, weight: "bold", fill: rgb("#7B4BEB"))
    #it.body
  ]
}

// Theme: opencode — imported from Typora CSS
// Generated by md-to-beautiful-pdf

#let doc-title = "%%DOC_TITLE%%"
#let doc-author = "%%DOC_AUTHOR%%"
#let accent       = rgb("#9d7cd8")
#let text-clr     = rgb("#333333")
#let light-text   = rgb("#666666")
#let link-clr     = rgb("#1a73e8")
#let code-clr     = rgb("#9d7cd8")
#let code-bg      = rgb("#f4f2f9")
#let block-bg     = rgb("#141414")
#let quote-border = rgb("#9d7cd8")
...
#set text(
  font: ("PingFang SC", "Arial", "Noto Sans CJK SC", "Hiragino Sans GB"),
  size: 11pt,
  fill: text-clr,
  lang: "zh",
)
...
#show heading.where(level: 1): it => {
  block(above: 2em, below: 0.8em, sticky: true)[
    #set text(size: 22pt, weight: "bold", fill: rgb("#9d7cd8"))
    #it.body
  ]
}
...
#show heading.where(level: 2): it => {
  block(above: 1.6em, below: 0.55em, sticky: true)[
    #set text(size: 16pt, weight: "bold", fill: rgb("#9d7cd8"))
    #it.body
  ]
}
...
#show raw.where(block: true): it => {
  block(
    ...
    #set text(
      font: ("JetBrains Mono", "Cascadia Code", "Menlo", "Courier New"),
      size: 9pt,
      fill: rgb("#2d2d2d"),
    )
    #it
